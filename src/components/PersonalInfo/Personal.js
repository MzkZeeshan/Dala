        ...
        >
          ...
          <View style={perStyle.View}>
            <View style={perStyle.Main}>
              <Text style={perStyle.H1}>Your Personal details</Text>
              <View>
              ...
              <View style={{ flexDirection: "row", paddingHorizontal: 25 }}>
                <View>
                  <Text style={perStyle.textbottom}>
                    Have you visited Asethetic for life in the last 12 months ?
                  </Text>
                </View>
                <View>
                  <Switch
              ...
              <View
                style={{ flexDirection: "row", paddingLeft: 20, paddingTop: 2 }}
              >
                <CheckBox
                ...
                />
                <View>
                  <Text style={perStyle.textbom}>
                    Tick this box if you don't want to receive emails from Dala3
                    with the latest offer & beauty news{" "}
                  </Text>
                </View>
              </View>
              <View
              ...
              >
                ...
                <View>
                  <Text style={perStyle.textbom}>
                    Tick to allow the venue i'm boking with to send me mail and
                    SMS about their services{" "}
                  </Text>
                </View>
              </View>
