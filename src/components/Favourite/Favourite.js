...
export default class Favourite extends Component {
  ...
  render() {
    return (
            <View style={{flex:1}}>
          <Head title="Favourite" setting={true} iconname="upload"/>
            <View style={Favstyle.highMain}>

                    <View style={Favstyle.high}>
                          
                            <Icon name='search1' style={{color:"#b2b2b2",fontSize:20,paddingVertical:10,paddingHorizontal:10,}} type="AntDesign" />
                            <TextInput
                            style={{flex:1}}
                  ...
                  <TouchableOpacity onPress={()=>Actions[RoutesKey.WAX_DETAIL]()}>
                    ...
                    <Icon name='star'  style={Favstyle.icon}  type="Entypo" />
                    <Icon name='star' style={Favstyle.icon}  type="Entypo" />
                    <Icon name='star-outlined'  style={Favstyle.icon}  type="Entypo" />
                ...
                <View  style={{flex:1}}> 
                <Text style={Favstyle.text}>Within fantasy Nails & Spa ,313 al Green road ,London (3103)</Text>
