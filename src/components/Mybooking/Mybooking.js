        ...
        <View style={{alignItems:"center"}}>
          ...
          <ScrollView>
            ...
            <View  style={BookStyle.onimageView}>
               <Text  style={{paddingVertical:5}} >Aesthetics For Life</Text>
                <View style={{flexDirection:"row" ,justifyContent:"space-between"}}>
                  ...
                  <View style={{paddingVertical:5,borderLeftWidth:1,borderLeftColor:"#f0f0f0",paddingHorizontal:10}}>
            ...
            <View >
                  ...
                  <Text style={BookStyle.waxh1}>Ladie's Waxing - Hollywood(Lycon Hot Wax)</Text>
                  <Text style={BookStyle.waxh2}>Within first available style /therapist (30min) </Text>
            </View>
            ...
            <View>
                ...
                <TouchableOpacity
                  ...
                  <Text style={LangStyle.Txt}>Manage Booking</Text>
                </TouchableOpacity>
